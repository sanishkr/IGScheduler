...
public class FileController {
    ...
    public String uploadFile(@RequestParam("file") MultipartFile file, @RequestParam String postdate, @RequestParam String posttime, @RequestParam String captions) {
        ...
        Igpost igp = igpostService.create(fileDownloadUri,postdate,posttime,captions);
